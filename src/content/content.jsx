  ...
  return (
    ...
    <div className="content">
      ...
      <div className="content-1">
        ...
        <ul>
            <li className="list-items"><a href="#">Work IntegrationEn</a></li>
            <li className="list-items"><a href="#">Project-Based Learning</a>

</li>
            <li className="list-items"><a href="#">Networking Opportunities
